...
import StudentTableDropdown from "components/Dropdowns/StudentTableDropdown.js";

export default function StudentDetails({ color }) {
         const [studentData,setStudentData] = useState([]);
         const resData=async()=>{
             const res = await axios.get("http://localhost:3000/api/studentDetails");
          ...
          <table className="items-center w-full bg-transparent border-collapse">
            ...
            <tbody>
                ...
                <td className="border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4 text-right">
                  <StudentTableDropdown idData={data._id}/>
                </td>
              </tr>
               ))}

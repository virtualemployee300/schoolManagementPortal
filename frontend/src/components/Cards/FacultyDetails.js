...
import FacultyTableDropdown from "components/Dropdowns/FacultyTableDropdown.js";

export default function FacultyDetails({ color }) {
         const [studentData,setStudentData] = useState([]);
         const resData=async()=>{
             const res = await axios.get("http://localhost:3000/api/facultyDetails");
          ...
          <table className="items-center w-full bg-transparent border-collapse">
            ...
            <tbody>
                ...
                <td className="border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4 text-right">
                  <FacultyTableDropdown idData={data._id}/>
                </td>
              </tr>
               ))}
